- **PPPL**: "PhongHNg's Personal Programming Library"
    - **PPPL-JS**: "PPPL — JavaScript"
    - **PPPL-CSS**: "PPPL — CSS"
    - **PPPL-WUIC**: "PPPL — Web User Interface Component"
- **elm**: element
- **args**: arguments
### Use in scripts/index.js
- **eci**: emergency contact information
### Use in scripts/Phinance.js
