...
| 7       | ```fADOM(form_unique_id, items, include_label, custom_item_types)``` | Extended PPPL_JS.ADOM for form.<br/> Item format: See <sup>[4]</sup>.<br/> Item data format:  [See here](https://github.com/phonghng/phonghng.github.io/blob/main/scripts/libraries/PPPL-JS.js#L241). |
